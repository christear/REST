...
if __name__=='__main__':
    ...
    if run=='train':
        ...
        for r in range(rounds):
            ...
            os.system('python DNABERT/examples/run_finetune.py \
                --model_type dna \
                --tokenizer_name=dna{} \
                --model_name_or_path {} \
                --task_name dnaprom \
                ...
                --overwrite_output \
                --weight_decay 0.01 \
                --n_process {}'.format(kmer,init_model, output_path, max_seq_len, batch_size, batch_size, train_epoch, output_path, n_process))
            ...
            os.system('python DNABERT/examples/run_finetune.py \
                ...
                --output_dir {} \
                --predict_dir {} \
                --n_process {}'.format(kmer,output_path,pred_path,max_seq_len ,batch_size, output_path,pred_path, n_process))
            ...
            #os.system('perl search.motif.pl {}.fa {}.pas.motif.pos 0 104'.format(pred_tsv,pred_tsv))
        ...
        os.system('python DNABERT/examples/run_finetune.py \
                ...
                --output_dir {} \
                --predict_dir {} \
                --n_process {}'.format(kmer,model, pred_path, max_seq_len,batch_size,model, pred_path, n_process))
        print('[INFO] finished prediction under: {}'.format(pred_path))
