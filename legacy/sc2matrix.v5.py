...
#    test_id = args.test_id
    ...
    # 
    #for _cb in cb_dict:
    #    print(cb_dict[_cb],_cb)
    #    if int(cb_dict[_cb] > 5):
    #        break
    #
    #
    ...
    def find_overlap(_cig_interval, datas):
        ...
        if len(out)!=0:
            ...
            return False
##
#    _overlap = find_overlap(cigar2interval([[10024599,10024690]]),ref_data['chr1']['-']['100'])
...
#                print(_UB,cig_interval,chr_ref_data[_strand][_seed])
            ...
            if _overlap != False:
                _overlap = _overlap[0]
#                print(_overlap)
                _outinfo = '{}\t{}\t{}\t{}\t{}'.format(_overlap[2],_cb,_UB,_overlap[0],_overlap[1])
#        print(_outinfo)
...
#    readbam_start_time = datetime.datetime.now()
    ...
    for _chr in ref_region:
        ...
        with Pool(thread) as p:
            ...
            #mex_out = processed_data_to_MEX(chr_processed_data)
        #_line_num += len(chr_processed_data)
